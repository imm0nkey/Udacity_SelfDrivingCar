...
### The focus here is on the architecture of multilayer neural networks, not parameter tuning, so here we'll just give
### you the learning parameters.
...
init = tf.global_bariables_initializer()
# Launch the graph
...
### In the next video, you'll see how changing the number of layers can affect your network.
